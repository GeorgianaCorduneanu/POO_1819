...
public class Main {
     ...
     */
    public Aluno registar_aluno(String username, Boolean licenciado){
        Aluno a;
     ...
     * e o montante
     */
    public void escolher_viagem_com_museu(){
        JPanel painel_principal = new JPanel(new FlowLayout());
        JPanel painel_botao = new JPanel(new BorderLayout());
     ...
     * @return, e retornado
     */
    public ArrayList<Viagem> gerar_viagens_com_museu(Aluno aluno_corrente, double montante_maximo){
     ...
     */
    public void todas_as_combinacoes_v02(ArrayList<Viagem> lista_aux_viagens, int iterator, List<Ponto_interesse> lista_pontos, Viagem v, double montante){
